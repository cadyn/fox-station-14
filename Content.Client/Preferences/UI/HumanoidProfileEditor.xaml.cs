...
namespace Content.Client.Preferences.UI
{
    ...
    public sealed partial class HumanoidProfileEditor : Control
    {
        ...
        private BoxContainer _markings => CMarkingsTab; // ANTHROSYSTEM MODIFICATION
            ...
            IEntityManager entityManager)
        {
            ...
            _markings.AddChild(HumanoidProfileEditor.MarkingsTab(_markingPicker));

            _tabContainer.SetTabTitle(3, "Markings");
